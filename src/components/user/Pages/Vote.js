...
import { GET_VOTE_PROGRESS, POST_VOTE_PROGRESS } from '../../../redux-saga/user/Vote/voteAction';
...
const Vote = () => {
    ...
    const connection = useSelector((state) => state.partyConnectionReducer);
    ...
    const fetchData = (index) => {
        let data = {
            Auth: userId,
            Party: connection.data[index].Party._id,
        };
        console.log(data);
        setvote({ ...vote, ...data });
    };
